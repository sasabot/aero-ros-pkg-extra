...
from aero_object_detector.cfg import ObjectDetectorConfig
...
class FCNObjectDetector():
    ...
    def __init__(self):
        ...
        ## load model list
        list_file = os.path.join(rospkg.RosPack().get_path("aero_object_detector"), "models/chainer/model_list.yaml")
        try:
