#include <aero_object_detector/dummy/object_3d_projector.h>

namespace aero_object_detector
{
...
PLUGINLIB_EXPORT_CLASS (aero_object_detector::DummyObject3DProjector, nodelet::Nodelet);
